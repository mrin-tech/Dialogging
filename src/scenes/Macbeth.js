class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.witch1 = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch1').setOrigin(0, 1).setScale(0.5);
        this.witch2 = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch2').setOrigin(0, 1).setScale(0.4);
        this.witch3 = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch3').setOrigin(0, 1).setScale(0.5);
        this.all = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'all').setOrigin(0, 1).setScale(0.5);
